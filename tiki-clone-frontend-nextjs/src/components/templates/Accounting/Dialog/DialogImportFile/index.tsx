...
import { LinearWithValueLabel } from './LinearWithValueLabelCustome'
...
export type Props = {
  refetch: () => void
  fetchDataImport: (val: any) => Promise<ResponseBody['POST']>
  fetchDataExport: () => Promise<BaseResponse<any>>
  label: string
}
  ...
  const renderFormUpload = () => {
    return (
      <div className='p-15'>
        ...
        <CoreInputFile file={file} handleSaveFile={handleSaveFile} label={label} />
        <Typography>

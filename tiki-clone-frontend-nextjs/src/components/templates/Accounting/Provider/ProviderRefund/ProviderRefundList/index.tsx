...
import useProviderRefundList from './useProviderRefundList'

const ProviderRefundList = () => {
  const { t } = useTranslation('accounting/provider-refund')

  const [values, handles] = useProviderRefundList()
      ...
      title={
        <div className='flex justify-between w-full'>
          ...
          <ButtonCustom
            ...
            textTransform='none'
            height={38}
            onClick={() => router.push(`${MENU_URL.PROVIDER.REFUND}/[addNew]`)}
          >
            {t('common:btn.add')}
          </ButtonCustom>
        </div>
...
export default ProviderRefundList

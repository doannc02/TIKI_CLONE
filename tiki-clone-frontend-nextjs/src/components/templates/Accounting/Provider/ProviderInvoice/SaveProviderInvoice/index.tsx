...
import { scopeProviderTypeSelect } from '@/enum'
...
import useSaveProviderInvoice from './useSaveProviderInvoice'
...
const SaveProviderInvoice = () => {
  const { t } = useTranslation('accounting/provider-invoice')
  const [values, handles] = useSaveProviderInvoice()
  const {
    id,
    actionType,
    data,
      ...
      title={
        <div className='flex justify-between w-full'>
          <CoreBreadcrumbs
            ...
            textPrev={t('title')}
            prevUrl={MENU_URL.PROVIDER.INVOICE}
          />
              ...
              onDeleteAction={() => {
                showDialog(
                  <DialogDeleteAccountMove
                    ...
                    refetch={() => {
                      router.push({
                        pathname: `${MENU_URL.PROVIDER.INVOICE}`,
                      })
                    }}
                  />
                )
          ...
          <div className='flex gap-5'>
            ...
            {data?.data && (
              <ButtonCustom
                ...
                onClick={() => {
                  router.push({
                    pathname: '/accounting/provider/providerInvoice/[id]/print',
                    query: {
                      id,
                      invoiceName,
                    },
      ...
      {isLoading ? (
        ...
        <div className='w-full flex flex-col'>
          <div className='flex justify-between items-center'>
            ...
            >
              <Tab label='Chi tiết hóa đơn' value='Detail' />
                ...
                <Grid container spacing={{ xs: 1, sm: 2, md: 3 }}>
                  ...
                  <Grid item xs={12} sm={12} md={4} lg={4}>
                    <CoreAutocomplete
                      ...
                      required
                      options={scopeProviderTypeSelect}
                      rules={{
...
export default SaveProviderInvoice

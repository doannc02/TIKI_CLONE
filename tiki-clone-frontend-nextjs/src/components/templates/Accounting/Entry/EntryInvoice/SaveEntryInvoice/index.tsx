  ...
  return (
    <PageContainer
      title={
        <div className='flex justify-between w-full'>
          <CoreBreadcrumbs
            ...
            textPrev={t('title')}
            prevUrl={MENU_URL.ENTRY.ENTRY_INVOICE}
          />
      ...
      action={
        <div className='bg-white flex justify-between w-full items-center'>
          <div>
            {watch('state') === 'POSTED' && watch('accountPaymentId') == null && (
              <ButtonCustom
                theme='submit'
                variant='contained'
                textTransform='none'
    ...
    >
      <div className='w-full flex flex-col'>
        <form className='bg-[#ffffff] px-15 py-15' onSubmit={onSubmit}>
          <Grid container spacing={{ xs: 1, sm: 2, md: 3 }}>
            ...
            <Grid item xs={12} sm={12}>
              <div className='flex gap-1 items-center mt-5'>
                <Typography variant='h6'>Hạng mục bút toán</Typography>
              </div>
            </Grid>

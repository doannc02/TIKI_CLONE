...
import useSaveCashAccount from './useSaveCashAccount'
...
const SaveCashAccount = () => {
  ...
  const [values, handles] = useSaveCashAccount()
  const {
    id,
    isUpdate,
    tab,
      ...
      title={
        <div className='flex justify-between w-full'>
          <CoreBreadcrumbs
            ...
            prevUrl={MENU_URL.CASH_ACCOUNT[paymentType]}
          />
          ...
          <div className='flex gap-5'>
            ...
            {paymentData && (
              <ButtonCustom
                ...
                onClick={() => {
                  router.push({
                    pathname: `${MENU_URL.CASH_ACCOUNT[paymentType]}/[id]/print`,
                    query: {
                      id: id,
...
export default SaveCashAccount

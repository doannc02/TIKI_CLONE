...
import useCustomerRefundList from './useCustomerRefundList'

const CustomerRefundList = () => {
  const { t } = useTranslation('accounting/customer-refund')

  const [values, handles] = useCustomerRefundList()
      ...
      title={
        <div className='flex justify-between w-full'>
          ...
          <ButtonCustom
            ...
            textTransform='none'
            height={38}
            onClick={() => router.push(`${MENU_URL.CUSTOMER.REFUND}/addNew`)}
          >
            {t('common:btn.add')}
          </ButtonCustom>
        </div>
...
export default CustomerRefundList

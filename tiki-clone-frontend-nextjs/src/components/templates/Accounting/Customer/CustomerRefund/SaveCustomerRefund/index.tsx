...
import useCustomerRefund from './useCustomerRefund'
      ...
      title={
        <div className='flex justify-between w-full'>
          <CoreBreadcrumbs
            ...
            textPrev={t('title')}
            prevUrl={MENU_URL.CUSTOMER.REFUND}
          />
              ...
              onCopyAction={() => {
                showDialog(
                  <DialogCopyInvoice
                    ...
                    refetch={() => {
                      router.push({
                        pathname: MENU_URL.CUSTOMER.REFUND,
                      })
                    }}
                  />
                )
          ...
          <div className='flex gap-5'>
            ...
            {data?.data && (
              <ButtonCustom
                ...
                onClick={() => {
                  router.push({
                    pathname: `${MENU_URL.CUSTOMER.REFUND}/[id]/print`,
                    query: {
                      id,
                      invoiceName,
                    },
...
export default SaveCustomerRefund

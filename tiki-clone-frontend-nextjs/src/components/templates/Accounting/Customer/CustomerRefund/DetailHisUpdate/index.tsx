...
import CustomCompareTable, { TableCompareInfInvoice } from '@/components/templates/Accounting/Customer/CustomerInvoice/DetailHisUpdate/components/tableCompareCustom'
      ...
      >
       <div className='py-25'>
          ...
          <ExpandableListItem
            ...
            header={
              <div className='flex justify-start item-center'>
                <Typography fontWeight='500'>Thông tin hóa đơn</Typography>
              </div>
            }
            content={
